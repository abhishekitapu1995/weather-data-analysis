...
weather_dyf = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": [f"s3://weather-data-gds-abhi/date={current_date}/weather_api_data.csv"],
        "recurse": True,
    },
...
redshift_output = glueContext.write_dynamic_frame.from_options(
    ...
    connection_options={
        "redshiftTmpDir": "s3://aws-glue-assets-692859933703-us-east-1/temporary/",
        "useConnectionProperties": "true",
        "aws_iam_role": "aarn:aws:iam::692859933703:role/service-role/AmazonRedshift-CommandsAccessRole-20250104T054853",
